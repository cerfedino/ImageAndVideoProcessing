...
\section{Theoretical exercise [2 points]}
Compute Fourier transform $G(\mu)$ of function $g(x) = f(x)+f(-x)$, where $f(x)$ is the function plotted in \autoref{fig:1a}.
...
\begin{figure}[h!]
    ...
    \begin{subfigure}{0.23\textwidth}
        \centering
        \includegraphics[width=\textwidth]{fig/out/6.img.png}
        \caption{Original image}
    \end{subfigure}
    \begin{subfigure}{0.23\textwidth}
        \centering
        \includegraphics[width=\textwidth]{fig/out/6.gaussian_filter_spatial.png}
        \caption{Spatial gaussian filter}
    \end{subfigure}
    \begin{subfigure}{0.23\textwidth}
        \centering
        \includegraphics[width=\textwidth]{fig/out/6.img_filtered.png}
...
\begin{figure}[h!]
    ...
    \begin{subfigure}{0.32\textwidth}
        \centering
        \includegraphics[width=.5\textwidth]{fig/out/6.img2.png}
...
\begin{tikzpicture}
    \begin{axis}[
      ...
      height=10cm,
      width=\textwidth]
    \addplot table[x=x, y=y, mark=none] {./fig/out/benchmark.dat};
    \addplot table[x=x, y=z, mark=none] {./fig/out/benchmark.dat};
