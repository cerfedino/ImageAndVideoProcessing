...
\begin{figure}[h!]
    ...
    \begin{subfigure}{0.27\textwidth}
        \centering
        \includegraphics[width=\textwidth]{fig/out/7.img.png}
        \includegraphics[width=\textwidth]{fig/out/7.img_fft.png}
        \caption{Original image}
    \end{subfigure}
    \begin{subfigure}{0.27\textwidth}
        \centering
        \includegraphics[width=\textwidth]{fig/out/7.res.png}
        \includegraphics[width=\textwidth]{fig/out/7.res_fft.png}
